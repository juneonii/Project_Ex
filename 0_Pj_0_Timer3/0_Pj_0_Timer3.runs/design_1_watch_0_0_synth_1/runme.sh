...
HD_PWD='C:/Users/Chajunwon/FPGA_Ex/Project_0_Watch/Pj_0_Timer3/0_Pj_0_Timer3/0_Pj_0_Timer3.runs/design_1_watch_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_watch_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_watch_0_0.tcl
